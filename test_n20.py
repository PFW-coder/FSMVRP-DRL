...
from FSMVRPTester import FSMVRPTester as Tester
...
tester_params = {
    ...
    'model_load': {
        'path': os.getcwd() + '/result/20250630_143919_train_20',  # directory path of pre-trained model and log files saved.
